...
@include('frontend.includes.sidebar')
	 <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        ...
        @include('frontend.includes.new_products')
       
        @include('frontend.includes.featured_products')
        
        @include('frontend.includes.best_seller')

        @include('frontend.includes.new_arrival')

        @include('frontend.includes.latest_blog')
